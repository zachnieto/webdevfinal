...
import { deleteAccountAndLogout, getProfile, updateUser } from "../actions/server-actions";
...
const Profile = () => {
    ...
    return (
        <div className="h-100 justify-content-center align-items-center">
            {session.user &&
                <div className="row justify-content-md-start justify-content-center text-center">
                    <h1>Profile</h1>
                    {
                        profile && (
                            <>
                                <div className="col-xl-4 col-lg-5 col-md-6 col-9">
                                    <PrivateProfileInfo
                                        ...
                                        bookmarked={profile.bookmarks} />
                                </div>
                                <div className="col-xl-2 col-lg-1 d-lg-flex d-md-none"></div>
                                <hr class="d-md-none dropdown-divider my-5" />

        ...
        <div className="row h-100 justify-content-center align-items-center">
            <div className="col-6 text-center">
                ...
                <div className="profile-details p-5">
                    <input className="form-control mt-3 mb-3" placeholder={session.user.username} type="text" onChange={e => setUsername(e.target.value)}/>
                    <input className="form-control mt-3 mb-3" placeholder="Password" type="password" onChange={e => setPassword(e.target.value)}/>
